...
public class ConfigLoader {
    ...
    public static void loadConfig() {
        ...
        config = load(configPath, ModConfig.class, new ModConfig(), "1of5 Error loading config file");
    ...
    public static void loadLang() {
        ...
        lang = load(langPath, LangConfig.class, new LangConfig(), "2of5 Error loading language file");
